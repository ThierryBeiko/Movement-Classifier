...
flagCalib = 0;
Start = 0;
nomFichier = 'rotationDroite_gaucheX.txt';

% Ouverture du port et du fichier où les données seront écrites
fopen(serialPort);
fichier = fopen(nomFichier,'w');
fprintf("Commencer les mouvements de rotation en sens antihoraire\r\n")
...
%     if mod(j,200)==0
%         fprintf(fichier, 'Rotation droite (horaire) %d \r\n',j/100);
%     else
%         if mod(j,100)==0
%             fprintf(fichier, 'Rotation gauche (antihoraire) %d \r\n',j/100);
%         end
%     end
