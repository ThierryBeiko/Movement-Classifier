...
#define GYRO_AVERAGE_OFFSET_X ((float) 3.50) // original 24.7)
#define GYRO_AVERAGE_OFFSET_Y ((float) 9.45) // original 22.31)
#define GYRO_AVERAGE_OFFSET_Z ((float)  -4.44) // original -14.41)
