...
flagCalib = 0;
Start = 0;
nomFichier = 'swipeHaut_BasX.txt';

% Ouverture du port et du fichier où les données seront écrites
fopen(serialPort);
fichier = fopen(nomFichier,'w');
fprintf("Commencer les mouvements de translation vers le HAUT\r\n")
...
%     if mod(j,200)==0
%         fprintf(fichier, 'Mouvement bas %d \r\n',j/100);
%     else
%         if mod(j,100)==0
%             fprintf(fichier, 'Mouvement haut %d \r\n',j/100);
%         end
%     end
